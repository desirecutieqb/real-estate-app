  ...
  return (
    <div className="relative h-screen">
      <Image
        ...
        alt="DesireCutieRent hero section"
        fill
      ...
      >
        <div className="max-w-4xl mx-auto px-16 sm:px-12">
          ...
          <p className="text-xl text-white mb-8">
            Explore our wide range of properties tailored to fit your LYFESTYLE
          </p>
          <div className="flex justify-center">
            <Input
              ...
              className="w-full max-lg rounded-none rounded-l-xl border-none bg-white h-12"
            />
